            ...
            <div className="relative z-10">
                ...
                <div className="logo-container flex flex-col sm:flex-row justify-start items-center mb-12">
                    ...
                    <div className="mision-vision-header text-left">
                        ...
                        <h2 className="transform-text text-white text-2xl">Transformando la exploración espacial en una experiencia educativa única.</h2>
                    </div>
                </div>
                ...
                <div className="grupo-imagenes mb-12 text-center">
                    <h1 className="text-3xl font-extrabold text-blue-100 mb-2">Nuestro Equipo</h1>
